...
mod tests {
    ...
    #[test]
    fn test_clean_transcript_single_line_string_assignment() -> Result<(), String> {
        //arrange
    ...
    //This is tested because transcript returned by whisper does have spaces between the word
    ...
    #[test]
    fn test_clean_transcript_handles_word_space_inside_double_quotes() -> Result<(), String> {
        //arrange
